...
data = pd.read_csv('scan_output_d.csv', header=None)  # Load data without header # change to read_excel for xlsx file
...
y_diff_df.to_csv('yd.csv', index=False, header=False)  # Save as CSV without index and header
